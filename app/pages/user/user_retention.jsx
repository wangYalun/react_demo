...
export default React.createClass({
    ...
    onSelectDate(day1, day2) {
        ...
        var it = this;
        api_base.request({
            url: '/api_selecter/user_retention',
    ...
    render() {
        ...
        return (<div>
            <Mod headerName="新注册用户留存率" onSelectDate={this.onSelectDate}><table className="detail-table">
                <thead>
                    <tr><td>注册时间</td><td>新增用户</td><td colSpan="16">留存率</td></tr>
                    <tr>
                        <td colSpan="2"></td>
                        <td>1天后</td><td>2天后</td>
                        <td>3天后</td><td>4天后</td>
